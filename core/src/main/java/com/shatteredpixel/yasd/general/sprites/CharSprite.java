...
import com.shatteredpixel.yasd.general.effects.IceBlock;
import com.shatteredpixel.yasd.general.effects.RedBlock;
import com.shatteredpixel.yasd.general.effects.RedShieldHalo;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public void move( int from, int to ) {
		...
		if (visible && Dungeon.level.liquid()[from] && !ch.flying) {
	...
	public final void jump( int from, int to, Callback callback ) {
	...
	public void onComplete( Tweener tweener ) {
		if (tweener == jumpTweener) {
			...
			if (visible && Dungeon.level.liquid()[ch.pos] && !ch.flying) {
