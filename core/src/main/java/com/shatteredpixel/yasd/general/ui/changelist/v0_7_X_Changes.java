...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.TENGU, 0, 0, 14, 16), "Enemy Balance Adjustments",
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
				...
				"_-_ Dual and gauntlets giving 1 more defense than what their descriptions stated\n" +
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.Weapons.GREATSWORD, new ItemSprite.Glowing( 0x440066 )), "Glyph/Enchant Buffs",
	...
	public static void add_v0_7_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.Weapons.GREATSWORD, new ItemSprite.Glowing(0xFF4400)), "Enchant/Glyph Buffs",
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.Weapons.GREATSWORD, new ItemSprite.Glowing(0xFFFF00)), "Enchantment Changes",
	...
	public static void add_v0_7_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.Weapons.GREATSWORD, new ItemSprite.Glowing(0x0000FF)), "Enchantment Overhaul!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.Weapons.SURPRISE_BENEFIT, new ItemSprite.Glowing(0xFF4400)), "Nerfed Enchants",
