	...
	public void activate() {
		...
		if (target != null) {
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
						...
						((MissileSprite) MainGame.scene().recycle(MissileSprite.class)).
							reset(pos, finalTarget.sprite, new PoisonDart(), new Callback() {
								...
								public void call() {
									...
									finalTarget.damage( dmg, false, new Char.DamageSrc(Element.VENOM, this) );
				...
				finalTarget.damage(Random.NormalIntRange(1, 4), false, new Char.DamageSrc(Element.VENOM, this));
				Buff.affect( finalTarget, Poison.class ).set( poisonAmount() );
			}
		}
	}
